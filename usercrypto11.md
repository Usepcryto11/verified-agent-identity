...
on:
  workflow_dispatch:
    inputs:
      agent_name:
        description: 'Usepcrypto11'
        required: true
        default: 'Usepcrypto11'
      agent_description:
        description: 'Usepcrypto11'
        required: true
        default: 'Usepcrypto11 AI Agent'
  ...
  verify:
    ...
    steps:
      ...
      - name: Step 3 - Link Human to Agent
        run: |
          node scripts/manualLinkHumanToAgent.js --challenge '{"name": "Usepcrypto11", "description": "Usepcrypto11 AI Agent"}'
